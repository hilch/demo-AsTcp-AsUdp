...
<SwConfiguration CpuAddress="SL0" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#2">
    <Task Name="tcp" Source="ANSIC.tcp.prg" Memory="UserROM" Language="ANSIC" BuildOptions="-W 6424" Debugging="true" />
    <Task Name="udp" Source="ANSIC.udp.prg" Memory="UserROM" Language="ANSIC" Debugging="true" />
  </TaskClass>
